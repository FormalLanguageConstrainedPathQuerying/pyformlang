...
class CFG(FormalGrammar):
    ...
    start_symbol:
        The start symbol, element of variables.
    productions:
    ...
    def get_generating_symbols(self) -> Set[CFGObject]:
        """Gets the objects which are generating in the CFG.
    ...
    def get_nullable_symbols(self) -> Set[CFGObject]:
        """Gets the objects which are nullable in the CFG.
    ...
    def generate_epsilon(self) -> bool:
        ...
        Returns
        -------
        Whether epsilon is generated by the CFG.
        """
    ...
    def get_reachable_symbols(self) -> Set[CFGObject]:
        """Gets the objects which are reachable in the CFG.
    ...
    def remove_epsilon(self) -> "CFG":
        """Removes the epsilon from the CFG.
    ...
    def get_unit_pairs(self) -> Set[Tuple[Variable, Variable]]:
        """Finds all the unit pairs in the CFG.
    ...
    def eliminate_unit_productions(self) -> "CFG":
        """Eliminates all the unit production in the CFG.
    ...
    def _get_productions_with_only_single_terminals(self) -> List[Production]:
        """Removes the terminals involved in a body of length more than 1."""
        term_to_var = {}
        new_productions = []
        for terminal in self._terminals:
    ...
    def to_normal_form(self) -> "CFG":
        ...
        Returns
        -------
        An equivalent grammar in the CNF form.
    ...
    def reverse(self) -> "CFG":
        ...
        Returns
        -------
        The reverse of current grammar.
        """
        productions = []
        for production in self._productions:
    ...
    def is_empty(self) -> bool:
        """Checks whether the CFG is empty or not.
    ...
    def contains(self, word: Iterable[Hashable]) -> bool:
        """Checks if the given word is in the grammar.
        ...
        Returns
        -------
        Whether the word is in the CFG or not.
        """
        # Remove epsilons
    ...
    def get_cnf_parse_tree(self, word: Iterable[Hashable]) -> ParseTree:
        """Gets a parse tree of the CNF of this grammar.
        ...
        Returns
        -------
        The parse tree of the given word in the CNF.
    ...
    def intersection(self, other: DeterministicFiniteAutomaton) -> "CFG":
        ...
        Returns
        -------
        A CFG representing the intersection.
        """
    ...
    def get_words(self, max_length: int = -1) -> Iterable[List[Terminal]]:
        """Gets the words generated by the CFG.
        ...
        Yields
        ------
        Words contained in the grammar.
        """
        nullables = self.get_nullable_symbols()
    ...
    def is_finite(self) -> bool:
        """Checks if the grammar is finite.
    ...
    def copy(self) -> "CFG":
        """Copies the current Context Free Grammar.

        Returns
        -------
        A copy of current Context Free Grammar.
        """
